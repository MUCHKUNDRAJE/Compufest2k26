...
const HeroSection = ({ imageUrl = "/image.png" }) => {
  ...
  // const greenShadow = "4px 4px 0px #166534";
   const greenShadow = "7px 7px 0px black";

  return (
    <div className="min-h-screen bg-[#0a1420]" style={pixelFont}>
      {/* Navbar */}
      <nav className="fixed w-full z-50 bg-[#0a1420]/90 backdrop-blur-sm border-b border-green-800 p-4">
     ...
     {/* Add this inside your component, perhaps right above the return statement */}
{/* Add this inside your component to handle the slow, infinite scroll */}
<style>{`
  @keyframes marquee {
...
</div>{/* Add this inside your component to handle the slow, infinite scroll */}
<style>{`
  @keyframes marquee {
    from { transform: translateX(0); }
    to { transform: translateX(-50%); }
